...
config :liftskit_backend, LiftskitBackendWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "aLpQ078XbEPCmOuKqCvAnjv9cQgKOZ65laj6VUhZdW9ULOOo3NhBFbj3kPj2bZqa",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:liftskit_backend, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:liftskit_backend, ~w(--watch)]}
  ]
...
config :liftskit_backend, LiftskitBackendWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/liftskit_backend_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :liftskit_backend, dev_routes: true
