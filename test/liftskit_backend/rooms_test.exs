defmodule LiftskitBackend.RoomsTest do
  ...
  describe "rooms" do
    ...
    import LiftskitBackend.RoomsFixtures
    ...
    test "list_rooms/0 returns all rooms" do
      ...
      assert length(Rooms.list_rooms()) >= 2
      assert room in Rooms.list_rooms()
      assert other_room in Rooms.list_rooms()
    end
