defmodule LiftskitBackendWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiftskitBackendWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiftskitBackendWeb.Gettext, "errors", msg, opts)
    end
  end
